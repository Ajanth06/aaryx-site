    ...
    <main className="min-h-screen w-full overflow-x-hidden bg-[#f7f3ea] text-[#171717]">
      ...
      <section className="mx-auto grid min-h-[calc(100vh-88px)] w-full max-w-7xl items-center gap-12 px-5 pb-12 pt-8 sm:px-8 lg:grid-cols-[1.02fr_0.98fr] lg:pb-16">
        ...
        <div className="relative mx-auto w-full max-w-2xl">
          <div className="min-h-[780px] overflow-hidden rounded-[2rem] bg-[#171717] p-4 shadow-2xl shadow-[#171717]/20 sm:min-h-[820px] sm:p-6">
            <div className="flex h-full flex-col rounded-[1.4rem] bg-[#fefaf1] p-4 sm:p-5">
              ...
              <div className="grid flex-1 content-between gap-2 py-3">
                <LiveMarketClocks />
